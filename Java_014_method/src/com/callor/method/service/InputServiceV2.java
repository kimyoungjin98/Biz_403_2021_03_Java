...
public class InputServiceV2 {
	...
	public Integer inputValue(String title, int start) {
		...
		while (true) {
			...
			if (intNum != null) {
				if (intNum < start) {
					System.out.printf("입력 값은 %d 이상이어야 합니다\n", start);
					continue;
				}
	...
	/*
	 * 정수 범위에 대한 유효성 검사를 하는 method 이미 만들어진 InputValue(String title) method와 연동하여
	 * 사용하겠다
	 */
	...
	public Integer inputValue(String title) {
		/*
		 * exception이 발생했을때 사용자에게 안내 메시지를 보내주고 다시 입력을 받도록 하기 위한 선 조치
		 */
		while (true) {
