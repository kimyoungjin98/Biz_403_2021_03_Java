...
//	private float avg;
	 ...
	 * 
	 * 따라서 ScoreVO 클래스에는 자동으로 toString() method가 있는 것 처럼 동작할 것이다
	 * 
	 * 하지만, Object 클래스에 정의된 toString() method는 
	 * 사용하는데 의미가 없다
	 * 
	 * 그래서 toString() method를 
	 * VO 객체의 변수에 담긴 값들을 문자열로 만들어 return하는 코드로 다시 작성을 한다
