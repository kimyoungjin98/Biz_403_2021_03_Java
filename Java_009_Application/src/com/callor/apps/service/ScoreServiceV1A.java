...
public class ScoreServiceV1A {
	...
	// 최초로 객체를 생성할 때 필요한 갯수를
	// 매개변수로 전달하고 전달받은 매개변수(members)의 값을
	// 사용하여 배열을 만들자
	...
	public void makeScores() {
		...
		while (true) {
			...
			if (score < 0 || score > 100) {
				System.out.println("점수를 0~100 까지만 입력하세요");
			} else {
				break;
			}
		}
	...
	// 여기에 사용된 Integer 키워드는
	// 변수를 선언하는 용도의 키워드가 아니고
	// return type 키워드라고 한다
	// method 코드내의 "return 값" 형식의 코드가
	// 반드시 있어야 함을 선언하는 것
