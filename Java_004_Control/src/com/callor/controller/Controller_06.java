...
/*
 * Jdk에는 수없이 많은 도구들이 포함되어 있따
 * lego 블럭을 이용해서 작품을 만드는 것 처럼 
 * Jdk에 있는 도구들을 사용하여 프로젝트를 만들 수 있다
 * Jdk에 있는 도구는 워낙 종류, 갯수가 많아서
 * 한꺼번에 프로젝트에 포함하면 프로젝트가 너무 거대해질 것이다
 * 이러한 문제를 방지하기 위하여 Java에서는 가장 기본적인 도구 외에는
 * 모두 파일로 제공하고 필요에 따라 import 하여 사용할 수 있도록 하고있다
 * 
 * import java.util.Random;
 * 지금부터 Controller_06 클래스에서
 * java.util 패키지의 Random 클래스 라는 도구를 사용하여 
 * 	코딩을 하겠다 라는 선언
 * 
 * eclipse에서 도구를 사용하기 위해서 
 * import 하고자 할때는 Ctrl + Shift + O를 눌러주면 된다
 * 
 * 코드의 모양을 정렬하기
 * Ctrl + Shift + F 
 * 
...
public class Controller_06 {
	...
	public static void main(String[] args) {
		 ...
		 *  	boolean, char 키워드에 확장된 기능을 할 수있도록
		 *  		만들어진 class 이다
		 *  
