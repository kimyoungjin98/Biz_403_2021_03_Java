 ...
 * 
 * 숫자가 정수형 일때는 4칙 연산의 결과가 모두 정수이다
 * 
 * 정수 / 정수 연산을 수행했을 때 결과는 나눗셈의 몫을 구하는 연산이 된다.
 * 
 * 정수 % 정수 연산을 수항하면 결과는 나머지를 구하는 연산이 된다.
 * 
 */
...
public class Hello_03 {
	...
	public static void main(String[] args) {
		...
		// java에서 실수의 표현 1
		// java는 실수를 표현할 때 10 -16승 까지 표현한다 
		// 소수점 이하 16자리 까지 표현하고 이후 값은 무시 또는 반올림 등을 수행한다
		System.out.println(40.0 / 30.0);
		
		// 정수와 실수의 연산
		// 정수와 실수가 섞여있는 연산 식에서는 모든 숫자를 실수로 변경하여 연산수행
		System.out.println(40 / 30.0);
		System.out.println(40.0 / 30);
		
		
		// 숫자 뒤에 f(F)를 부착하면 단축형 실수가 된다
		// 소수점 이하 7째자리 까지만 인식한다
		System.out.println(40F / 30F);
		System.out.println(40f/ 30f);
		
		// 단정도 실수 : 소수이하 7(6)째 자리까지 표현 하는 실수
